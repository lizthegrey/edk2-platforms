...
Scope(_SB)
{
  ...
  Device (PCI2)
  {
    ...
    Name (_CID, "PNP0A03") // Compatible PCI Root Bridge
    Name (_UID, 0x2)
    Name(_SEG, LX2160A_PCI_SEG2) // Segment of this Root complex
    Name(_BBN, 0) // Base Bus Number
    Name(_CCA, 1) // Cache Coherency Attribute
    Name (RBUF, ResourceTemplate () {
      WordBusNumber ( // Bus numbers assigned to this root
      ...
      QWordMemory ( // 32-bit BAR Windows
        ...
        ReadWrite,
        0x0,                           // Granularity
        LX2160A_PCI_SEG2_MMIO32_MIN,   // Min Base Address
        LX2160A_PCI_SEG2_MMIO32_MAX,   // Max Base Address
        LX2160A_PCI_SEG2_MMIO32_XLATE, // Translate
        LX2160A_PCI_SEG2_MMIO32_SIZE   // Length
      )
      QWordMemory ( // 64-bit BAR Windows
        ResourceProducer,
        PosDecode,
        ...
        ReadWrite,
        0x0,                           // Granularity
        LX2160A_PCI_SEG2_MMIO64_MIN,   // Min Base Address
        LX2160A_PCI_SEG2_MMIO64_MAX,   // Max Base Address
        0x0,                           // Translate
        LX2160A_PCI_SEG2_MMIO64_SIZE   // Length
      )
      QWordIO ( // IO window
        ResourceProducer,
        MinFixed,
        ...
        EntireRange,
        0x0,                            // Granularity
        LX2160A_PCI_SEG2_IO64_MIN,      // Min Base Address
        LX2160A_PCI_SEG2_IO64_MAX,      // Max Base Address
        LX2160A_PCI_SEG2_IO64_XLATE,    // Translate
        LX2160A_PCI_SEG2_IO64_SIZE      // Length
      )
    })
    ...
    Device (RES1)
    {
      Name (_HID, "NXP0016") // NXP PCIe RC config base address
      Name (_CRS, ResourceTemplate (){
        Memory32Fixed (ReadWrite, LX2160A_PCI_SEG2_RC_CONFIG_BASE,
                       LX2160A_PCI_SEG2_RC_CONFIG_SIZE)
      })
    }

    // PCI Routing Table
    Name (_PRT, Package () {
            Package () { 0xFFFF, 0, Zero, LX2160A_PCI_SEG2_INTA },   // INTA
            Package () { 0xFFFF, 1, Zero, LX2160A_PCI_SEG2_INTB },   // INTB
            Package () { 0xFFFF, 2, Zero, LX2160A_PCI_SEG2_INTC },   // INTC
            Package () { 0xFFFF, 3, Zero, LX2160A_PCI_SEG2_INTD },   // INTD
            })
    //
    // OS Control Handoff
    //
  ...
  Device (RES2)
  {
    Name (_HID, "NXP0016") // NXP PCIe RC config base address
    Name (_CID, "PNP0C02") // Motherboard reserved resource
    Name (_UID, LX2160A_PCI_SEG2)  //  Unique ID
    Name (_CRS, ResourceTemplate (){
      Memory32Fixed (ReadWrite, LX2160A_PCI_SEG2_RC_CONFIG_BASE,
              LX2160A_PCI_SEG2_RC_CONFIG_SIZE)
    })
  ...
  Device (RESP)  //reserve for ecam resource
  {
     ...
     Name (_CRS, ResourceTemplate (){
       ...
       QwordMemory ( //ECAM space for [bus 00-ff]
         ...
         ReadWrite,
         0x0,                               // Granularity
         LX2160A_PCI_SEG2_CONFIG_BASE,      // Min Base Address
         LX2160A_PCI_SEG2_CONFIG_BASE_MAX,  // Max Base Address
         0x0,                               // Translate
         LX2160A_PCI_SEG2_CONFIG_SIZE       // Length
       )
#endif
     })
  }
