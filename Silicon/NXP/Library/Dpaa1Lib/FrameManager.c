  ...
  )
{
  ...
  Val = GetMmioOperations(TRUE)->Read32(Base);
  ...
  )
{
  ...
  UINT32 Org = GetMmioOperations(TRUE)->Read32(Base);
  UINT32 Val;
  INT32 Pos;
  ...
  GetMmioOperations(TRUE)->Write32(Base, Val);
}
...
{ 
  ...
  DPAA1_DEBUG_MSG("Address      : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Cfg->Address      ));
  DPAA1_DEBUG_MSG("Data         : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Cfg->Data         ));
  DPAA1_DEBUG_MSG("TimingConfig : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Cfg->TimingConfig ));
  DPAA1_DEBUG_MSG("DataReady    : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Cfg->DataReady    ));
}
  ...
  )
{
  ...
  DPAA1_DEBUG_MSG("Tnc  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Tnc  ));
  DPAA1_DEBUG_MSG("Prc  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Prc  ));
  DPAA1_DEBUG_MSG("Flc  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Flc  ));
  DPAA1_DEBUG_MSG("Dist1: 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Dist1));
  DPAA1_DEBUG_MSG("Dist2: 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Dist2));
  DPAA1_DEBUG_MSG("Epi  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Epi  ));
  DPAA1_DEBUG_MSG("Rie  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Rie  ));
  for (I =0; I < 0x4; I++)
    DPAA1_DEBUG_MSG("Fcev[%d]  : 0x%x \n",I, GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Fcev[I]));

  for (I =0; I < 0x4; I++)
    DPAA1_DEBUG_MSG("Fcmask[%d]  : 0x%x \n",I, GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Fcmask[I]));

  DPAA1_DEBUG_MSG("Tsc1 : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Tsc1));
  DPAA1_DEBUG_MSG("Tsc2  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Tsc2));
  DPAA1_DEBUG_MSG("Tsp  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Tsp ));
  DPAA1_DEBUG_MSG("Tsf  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Tsf ));
  DPAA1_DEBUG_MSG("Rcr  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Rcr ));

  for (I =0; I < 0x4; I++)
    DPAA1_DEBUG_MSG("Drd[%d]  : 0x%x \n", I, GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Drd[I]));

  DPAA1_DEBUG_MSG("Dra    : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Dra   ));
  DPAA1_DEBUG_MSG("IpRev1 : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->IpRev1));
  DPAA1_DEBUG_MSG("IpRev2 : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->IpRev2));
  DPAA1_DEBUG_MSG("Rstc   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Rstc  ));
  DPAA1_DEBUG_MSG("Cldc   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Cldc  ));
  DPAA1_DEBUG_MSG("Npi    : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Npi   ));
  DPAA1_DEBUG_MSG("FpEe   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->FpEe  ));

  for (I =0; I < 0x4; I++)
    DPAA1_DEBUG_MSG("Cev[%d]  : 0x%x \n", I, GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Cev[I]));

  for (I =0; I < 0x40; I++)
    DPAA1_DEBUG_MSG("Ps[%d]  : 0x%x \n",I, GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Ps[I]));

  for (I =0; I < 0x80; I++)
    DPAA1_DEBUG_MSG("Ts[%d]  : 0x%x \n",I, GetMmioOperations(TRUE)->Read32((UINTN)&Fpm->Ts[I]));
}
  ...
  )
{
  ...
  DPAA1_DEBUG_MSG(" Gc    : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Gc   ));
  DPAA1_DEBUG_MSG(" Eie   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Eie  ));
  DPAA1_DEBUG_MSG(" Eien  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Eien ));
  DPAA1_DEBUG_MSG(" Eif   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Eif  ));
  DPAA1_DEBUG_MSG(" Ie    : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Ie   ));
  DPAA1_DEBUG_MSG(" Ien   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Ien  ));
  DPAA1_DEBUG_MSG(" If    : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->If   ));
  DPAA1_DEBUG_MSG(" Gs    : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Gs   ));
  DPAA1_DEBUG_MSG(" Ts    : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Ts   ));
  DPAA1_DEBUG_MSG(" Etfc  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Etfc ));
  DPAA1_DEBUG_MSG(" Dtfc  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dtfc ));
  DPAA1_DEBUG_MSG(" Dc0   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dc0  ));
  DPAA1_DEBUG_MSG(" Dc1   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dc1  ));
  DPAA1_DEBUG_MSG(" Dc2   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dc2  ));
  DPAA1_DEBUG_MSG(" Dc3   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dc3  ));
  DPAA1_DEBUG_MSG(" Dfnoc : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dfnoc));
  DPAA1_DEBUG_MSG(" Dfcc  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dfcc ));
  DPAA1_DEBUG_MSG(" Dffc  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dffc ));
  DPAA1_DEBUG_MSG(" Dcc   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dcc  ));
  DPAA1_DEBUG_MSG(" Dtrc  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Dtrc ));
  DPAA1_DEBUG_MSG(" Efddd : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qmi->Efddd));
}
  ...
  )
{
  ...
  DPAA1_DEBUG_MSG(" Init;           : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Init));
  DPAA1_DEBUG_MSG(" Cfg1;           : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Cfg1));
  DPAA1_DEBUG_MSG(" Cfg2;           : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Cfg2));
  DPAA1_DEBUG_MSG(" Ievr;           : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Ievr));
  DPAA1_DEBUG_MSG(" Ier;            : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Ier ));
  DPAA1_DEBUG_MSG(" Ifr;            : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Ifr ));
  DPAA1_DEBUG_MSG(" Gde;            : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Gde ));
  for (I =0; I < 0x3f; I++)
    DPAA1_DEBUG_MSG("Pp[%x] : 0x%x \n", I, GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Pp[I]));
  
  for (I =0; I < 0x3f; I++)
    DPAA1_DEBUG_MSG("Pfs[%x] : 0x%x \n", I, GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Pfs[I]));

  for (I =0; I < 0x3f; I++)
    DPAA1_DEBUG_MSG("Ppid[%x] : 0x%x \n", I, GetMmioOperations(TRUE)->Read32((UINTN)&Bmi->Ppid[I]));
}
  ...
  )
{
  ...
  DPAA1_INFO_MSG(" Sr   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Sr  ));
  DPAA1_INFO_MSG(" Mr   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Mr  ));
  DPAA1_INFO_MSG(" Tr   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Tr  ));
  DPAA1_INFO_MSG(" Hy   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Hy  ));
  DPAA1_INFO_MSG(" Setr : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Setr));
  DPAA1_INFO_MSG(" Tah  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Tah ));
  DPAA1_INFO_MSG(" Tal  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Tal ));
  DPAA1_INFO_MSG(" Tcid : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Tcid));
  DPAA1_INFO_MSG(" Ra   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Ra  ));
  DPAA1_INFO_MSG(" Rd   : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Rd  ));
  DPAA1_INFO_MSG(" Dcr  : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Dcr ));
  DPAA1_DEBUG_MSG(" Emsr : 0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Emsr));
  for (I =0; I < 32; I++)
    DPAA1_INFO_MSG("Plr[%d] : 0x%x \n", I, GetMmioOperations(TRUE)->Read32((UINTN)&Dma->Plr[I]));
}
  ...
  )
{
  ...
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTcfg;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTcfg));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTst;   	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTst ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTda;   	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTda ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfp;   	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfp ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfed;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfed));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTicp;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTicp));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfne;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfne));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfca;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfca));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTcfqid;	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTcfqid));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfeqid;	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfeqid));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfene; 	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfene));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTrlmts;	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTrlmts));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTrlmt; 	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTrlmt));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTstc;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTstc ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfrc;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfrc ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfdc;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfdc ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfledc;	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfledc));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfufdc;	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfufdc));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTbdc;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTbdc ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTpc;   	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTpc  ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTpcp;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTpcp ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTccn;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTccn ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTtuc;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTtuc ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTtcquc;	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTtcquc));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTduc;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTduc ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTfuc;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTfuc ));
  DPAA1_DEBUG_MSG("  TxPort->FmanBmTdcfg;  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->TxPort->FmanBmTdcfg));

  DPAA1_DEBUG_MSG("  RxPort	: 	0x%x ---------\n", FmanEthDevice->RxPort);
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRcfg      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRcfg));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRst 	 	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRst));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRda       	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRda));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfp       	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfp));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfed      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfed));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRicp      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRicp));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRim 	 	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRim ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRebm      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRebm));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfne      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfne));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfca      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfca));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfpne     	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfpne));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRpso      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRpso ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRpp       	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRpp  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRccb      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRccb ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRprai[0x8]	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRprai[0x8] ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfqid     	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfqid ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRefqid    	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRefqid));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfsdm     	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfsdm ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfsem     	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfsem ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfene     	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfene ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmEbmpi[0x8]	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmEbmpi[0x8] ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmAcnt[0x8] 	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmAcnt[0x8]  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmCgm[0x8]  	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmCgm[0x8]   ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmMpd       	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmMpd   ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRstc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRstc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfrc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfrc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfbc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfbc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRlfc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRlfc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRffc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRffc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfdc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfdc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfldec    	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfldec));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRodc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRodc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRbdc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRbdc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRpc       	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRpc   ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRpcp      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRpcp  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRccn      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRccn  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRtuc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRtuc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRrquc     	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRrquc ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRduc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRduc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRfuc      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRfuc  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRpac      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRpac  ));
  DPAA1_DEBUG_MSG("  RxPort->FmanBmRdbg      	: 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&FmanEthDevice->RxPort->FmanBmRdbg  ));
...
{                                                                               
   ...
   DPAA1_DEBUG_MSG("  BufPtrLo   : 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Bd->BufPtrLo));
   Bd++;
  }
}
  ...
  )
{
   ...
   DPAA1_DEBUG_MSG("  BdRingBaseLo   : 	0x%x \n", GetMmioOperations(TRUE)->Read32((UINTN)&Qd->BdRingBaseLo));
  ...
  )
{
  ...
  GetMmioOperations(TRUE)->Write32((UINTN)&Pram->Mode, PARAM_MODE_GLOBAL);

  /* init Rx queue descriptor pointer */
  GetMmioOperations(TRUE)->Write32((UINTN)&Pram->RxqdPtr, PramPageOffset + 0x20);
  ...
  for (I = 0; I < RX_RING_SIZE; I++) {
    ...
    GetMmioOperations(TRUE)->Write32((UINTN)&RxBd->BufPtrLo, BufLo);
    RxBd++;
  }
  ...
  GetMmioOperations(TRUE)->Write32((UINTN)&RxQd->BdRingBaseLo, BdRingBaseLo);
  ...
  GetMmioOperations(TRUE)->Write32((UINTN)&BmiRxPort->FmanBmRfqid, PramPageOffset);
  ...
  )
{
  ...
  GetMmioOperations(TRUE)->Write32((UINTN)&Pram->TxqdPtr, PramPageOffset + 0x40);
  ...
  for (I = 0; I < TX_RING_SIZE; I++) {
    ...
    GetMmioOperations(TRUE)->Write32((UINTN)&TxBd->BufPtrLo, 0);
    TxBd++;
  }
  ...
  GetMmioOperations(TRUE)->Write32((UINTN)&TxQd->BdRingBaseLo, BdRingBaseLo);
  ...
  GetMmioOperations(TRUE)->Write32((UINTN)&BmiTxPort->FmanBmTcfqid, PramPageOffset);
  ...
  )
{
  ...
  //
  GetMmioOperations(TRUE)->Write32((UINTN)&FmanControllerConfig->Address,
  ...
  //
  GetMmioOperations(TRUE)->Write32((UINTN)&FmanControllerConfig->Address, 0);
  do {
    MicroSecondDelay(1);
   ...
   */
  GetMmioOperations(TRUE)->Write32((UINTN)&FmanControllerConfig->DataReady,
...
FmanInitQmanInterface(FMAN_QMI_COMMON *Qmi)
{
  ...
  GetMmioOperations(TRUE)->And32((UINTN)&Qmi->Gc, ~(QMI_GC_ENQ_EN | QMI_GC_DEQ_EN));

  // Disable all error interrupts
  GetMmioOperations(TRUE)->Write32((UINTN)&Qmi->Eien, 0x0);

  // Clear all error events ("write 1 to clear" bits)
  GetMmioOperations(TRUE)->Write32((UINTN)&Qmi->Eie, QMI_EIE_ALL);

  // Disable all interrupts */
  GetMmioOperations(TRUE)->Write32((UINTN)&Qmi->Ien, 0x0);

  // Clear all interrupts ("write 1 to cleae" bits)
  GetMmioOperations(TRUE)->Write32((UINTN)&Qmi->Ie, QMI_IE_ALL);
}
...
FmanInitFPM(FMAN_FPM *Fpm)
{
  ...
  //
  GetMmioOperations(TRUE)->Or32((UINTN)&Fpm->FpEe,
  ...
  for(Index = 0; Index < FMAN_MAX_NUM_OFFLINE_PORTS; Index++) {
    ...
    GetMmioOperations(TRUE)->Write32((UINTN)&Fpm->Prc, RegValue);
  }
  ...
  //
  GetMmioOperations(TRUE)->Write32((UINTN)&Fpm->Flc, FPM_FLC_DISPATCH_LIMIT_NONE);

  //
  // Clear events (write 1 to clear):
  //
  GetMmioOperations(TRUE)->Write32((UINTN)&Fpm->FpEe, FPM_FPEE_ALL_EVENTS);

  //
  // Clear CPU events (write 1 to clear):
  //
  for(Index = 0; Index < ARRAY_SIZE(Fpm->Cev); Index++) {
    GetMmioOperations(TRUE)->Write32((UINTN)&Fpm->Cev[Index], 0xFFFFFFFF);
  }

  //
  // Clear ECC events (write 1 to clear) for Fman internal memory access:
  //
  GetMmioOperations(TRUE)->Write32((UINTN)&Fpm->Rcr, FPM_RCR_MDEC | FPM_RCR_IDEC);
}
  ...
  )
{
  ...
  GetMmioOperations(TRUE)->Write32((UINTN)&Bmi->Cfg1, RegValue);

  //
  // Disable and clear all interrupts:
  //
  GetMmioOperations(TRUE)->Write32((UINTN)&Bmi->Ier, 0x0);
  GetMmioOperations(TRUE)->Write32((UINTN)&Bmi->Ievr, BMI_IEVR_ALL);
  ...
  for(Index = 0; Index < FMAN_MAX_NUM_OFFLINE_PORTS; Index++) {
    ...
    GetMmioOperations(TRUE)->Write32((UINTN)&Bmi->Pp[PortIndex], 0x0);
    GetMmioOperations(TRUE)->Write32((UINTN)&Bmi->Pfs[PortIndex], 0x0);
  }
  ...
  for(Index = 0; Index < FMAN_MAX_NUM_RX_1G_PORTS; Index++) {
    ...
    GetMmioOperations(TRUE)->Write32((UINTN)&Bmi->Pp[PortIndex], RegValue);
    RegValue = 0;
    __SET_BIT_FIELD32(RegValue, BMI_PFS_IFSZ_MASK, BMI_PFS_IFSZ_SHIFT, 0xf);
    GetMmioOperations(TRUE)->Write32((UINTN)&Bmi->Pfs[PortIndex], RegValue);
  }
  ...
  //
  GetMmioOperations(TRUE)->Write32((UINTN)&Bmi->Init, BMI_INIT_START);
  ...
  )
{
  ...
  if (!(Status & Rx_EMPTY)) {
    if (!(Status & Rx_ERROR)) {
      ...
      BufLo = GetMmioOperations(TRUE)->Read32((UINTN)&Rxbd->BufPtrLo);
  ...
  )
{
  ...
  GetMmioOperations(TRUE)->Write32((UINTN)&Txbd->BufPtrLo, Lower32Bits((UINTN)Data));
  ...
  )
{
  ...
  if ((0 == FmanEthDevice->TotalPendingTxbd) ||
    ...
    *TxBuf = NULL;
    ...
    BufLo = GetMmioOperations(TRUE)->Read32((UINTN)&Txbd->BufPtrLo);
